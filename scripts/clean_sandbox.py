...
class SandboxBot(Bot):
    ...
    availableOptions = {
        ...
        'delay': None,
        'delay_td': None,
        'text': '{{คำแนะนำ|title=โดนเจอซะแล้วซิ~|content=สวัสดี ที่นี่คือหน้ากระบะทราย สามารถเขียนอะไรก็ได้ แต่! ระวังนะ ด้วยอาณานุภาพแห่ง{{c|ท่านผู้นั้น}} มันจะอยู่ได้ไม่นาน..<br><span class="user-show">''[[พิเศษ:หน้าของฉัน/กระบะทราย|แต่ถ้าที่นี่จะไม่หายไปนะ!]]''</span>}}',
        'summary': 'ล้างทำความสะอาดรอคนต่อไป...',
    }
